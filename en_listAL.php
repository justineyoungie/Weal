	...
	<div id="page-wrapper">
        <div class="container-fluid">
			...
			<section class="content-header">
			  <h1><b>
				Material List</b><br>
				<small>Select the material</small>
			  </h1>
			  <ol class="breadcrumb">
                ...
                <div class="row">
					...
					<br>
                        <div class="col-xs-12">
						<form style="height: 250px" action="adminEditMaterial.php" method="get">
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
								...
								$query="select PH.phaseID, PH.phaseName, PH.projectCode, P.projectName from phases PH JOIN PROJECTS P ON P.PROJECTCODE = PH.PROJECTCODE WHERE pStatusID = 4";
								...
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
									...
									<td><a href='en_createAL?p=".$row['phaseID']."'><button type='button' name='submit'>CREATE</button></a></td>
