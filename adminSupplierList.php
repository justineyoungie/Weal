...
if (isset($_POST['submit'])){
  ...
  header("Location: adminEditSupplier.php"); /* Redirect browser */
	exit();
	...
	<div id="page-wrapper">
        <div class="container-fluid">
			...
			<section class="content-header">
			  <h1><b>
				Supplier List</b><br>
				<small>Select the supplier record</small>
			  </h1>
			  <ol class="breadcrumb">
                ...
                <div class="row">
					...
					<br>
                        <div class="col-xs-12">
						<form style="height: 250px" action="adminEditSupplier.php" method="get">
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php
								...
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
									...
									<td>{$row['cellphoneNum']}</td>
									<td>{$row['faxNum']}</td>
									<td><button value={$row['supplierID']} type='submit' name='submit'>EDIT</td>
