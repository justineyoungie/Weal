...
$query="insert into ref_saddress (sAddress) values ('{$sAddress}')";
$result=mysqli_query($dbc,$query);
$message="<b><p>Address: {$sAddress} added! </b>";
  ...
  <div class="content-wrapper">
    <div class="box">
      ...
      <section class="content-header">
        <h1>
          Create Address<br>
          <small>Creates records of addresses</small>
        </h1>
        <ol class="breadcrumb">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              <!-- DIMENSIONS -->
                        <div class="col-xs-8 form-group">
                            <label for="input1">Dimensions</label>
                            <input required type="text" class="form-control input" id="input1" placeholder="Enter address..." name="sAddress">
                        </div>
					...
					<div class="col-xs-8 form-group">
						<a href="adminCreateSupplier.php"><button type="button" name="back" value="Back">Back</button></a>
					</div>
			</form>
            </div>
        </div>
