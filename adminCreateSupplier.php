...
//productname field (dinefine ni sir sa html yung field name as productname)
 if (empty($_POST['supplierName'])){
  $supplierName=NULL;
  $message.='<p>You forgot to enter the supplier name!';
 }else
  $supplierName=$_POST['supplierName'];

 if (empty($_POST['contactPerson'])){
  $contactPerson=NULL;
  $message.='<p>You forgot to enter the name of the contact person!';
 }else
 ...
 if (empty($_POST['telephoneNum'])){
  ...
  $cellphoneNum=NULL;
  $message.='<p>You forgot to enter the cellphone number!';
 }else
  $cellphoneNum=$_POST['cellphoneNum'];

   if (empty($_POST['faxNum'])){
  $faxNum=NULL;
...
$query="insert into suppliers (supplierName,contactPerson,telephoneNum, cellphoneNum, faxNum) values ('{$supplierName}','{$contactPerson}','{$telephoneNum}', '{$cellphoneNum}', '{$faxNum}')";
$result=mysqli_query($dbc,$query);
$message="<b><p>Supplier: {$supplierName} added! </b>";
  ...
  <div class="content-wrapper">
    <div class="box">
      ...
      <section class="content-header">
        <h1>
          Create Suppliers<br>
          <small>Creates records of suppliers</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="col-xs-8 form-group">
                            <label for="input2">Supplier Name</label>
                            <input type="text" name="supplierName" class="form-control input" id="input2" placeholder="Enter Supplier Name" required>
                        </div>
						<!-- CURRENT CREDIT -->
                        <div class="col-xs-8 form-group">
                            <label for="input2">Contact Person</label>
                            <input type="text" name="contactPerson" class="form-control input" id="input2" placeholder="Enter Contact Person" required>
                        </div>
                    
						<!-- Customer FIRST NAME -->
                        <div class="col-xs-8 form-group">
                            <label for="input1">Telephone Number</label>
                            <input type="text" name="telephoneNum" class="form-control input" id="input1" placeholder="Enter Telephone Number" required>
                        </div>
						<!-- Customer LAST NAME -->
                        <div class="col-xs-8 form-group">
                            <label for="input1">Cellphone Number</label>
                            <input type="text" name="cellphoneNum" class="form-control input" id="input1" placeholder="Enter Cellphone Number" required>
                        </div>
						<!-- Customer LAST NAME -->
                        <div class="col-xs-8 form-group">
                            <label for="input1">Fax Number</label>
                            <input type="text" name="faxNum" class="form-control input" id="input1" placeholder="Enter Fax Number" required>
                        </div>
						<!-- MATERIAL DIMENSIONS -->	
                        ...
                        <div class="col-xs-6 form-group">
							...
							<?php
								...
								$query="select * from ref_saddress";
								$result=mysqli_query($dbc,$query);
								
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
									echo "<option value={$row['sAddressID']}>{$row['sAddress']}</option>";
								}
							?>
							</select>
					...
					<a href="adminCreateAddress.php"><button  type="button" class="btn btn-success btn-fill" >ADD ADDRESS</button></a>
