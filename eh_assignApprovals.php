					...
					<br>
						...
						<tr>
							...
							<tr>
								...
								<?php
								$query = "SELECT * FROM ref_docutype";
								$result = mysqli_query($dbc, $query);
								
								while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
									echo '<option value = "'.$row['docutypeID'].'">'.$row["docutype"].'</option>';
								}
								?>
								...
								<?php
								$query = "SELECT * FROM ref_approve";
								$result = mysqli_query($dbc, $query);
								
								while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
									echo '<option value = "'.$row['approveID'].'">'.$row["approve"].'</option>';
								}
								?>
