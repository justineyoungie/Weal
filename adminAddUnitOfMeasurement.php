...
//productname field (dinefine ni sir sa html yung field name as productname)
 if (empty($_POST['unit'])){
  $unit=NULL;
  $message.='<p>You forgot to enter the unit name!';
 }else
  $unit=$_POST['unit'];
...
$query="insert into ref_units (unit) values ('{$unit}')";
$result=mysqli_query($dbc,$query);
$message="<b><p>Unit: {$unit} added! </b>";
  ...
  <div class="content-wrapper">
    <div class="box">
      ...
      <section class="content-header">
        <h1>
          Add Unit of Measurement<br>
          <small>Creates records of measurements</small>
        </h1>
        <ol class="breadcrumb">
      ...
      <section class="content">
        ...
        <div class="row">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              <!-- MATERIAL NAME -->
                        <div class="col-xs-8 form-group">
                            <label for="input1">Unit of Measurement Name</label>
                            <input required type="text" class="form-control input" id="input1" placeholder="Enter U.O.M Name" name="unit">
                        </div>
			...
			<div class="col-xs-8 form-group">
						<a href="adminCreateMaterials.php"><button name="back" value="Back">Back</button></a>
					</div>
