...
if (isset($_POST['createRS'])){
	...
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
		...
		while (isset($_SESSION['cart'][$row['subphaseName']][$ctr])){
			...
			$queryA = "INSERT INTO `rsdetails` (`materialID`, `quantity`, `rsNumber`, `subphaseID`, `statusID`) 
			VALUES ('".$materialID."', '".$qty."', '".$rsID."', '".$row['subphaseID']."', '9')";
...
<div class="modal modal-default fade" id="modal-default" style="display: none;">
          <div class="modal-dialog">
            <div class="modal-content">
			  ...
			  <input type = "date" class = "form-control" id = "dateNeeded" name = "dateNeeded" value = "" required>
			  </div>
