        ...
        <div class="container-fluid">
            <div class="box">
								<section class="content-header">
									...
									<small>Select from the list of suppliers to generate a purchase order for that supplier</small>
									</h1>
                </section>
                <div class="row">
                    <div class="col-lg-12">
					<br>
                        <div class="col-xs-12">
													<form action="ph_CreatePO.php" method="get">
														<table id="example2" class="table table-bordered table-hover">
															...
															<tr>
																...
																<th>Cellphone #</th>
																<th>Fax #</th>
																<th>Number of Unique Materials to Order</th>
																<th>Options</th>
															</tr>
															</thead>
															<tbody>
																<?php
																	$query = "SELECT 	S.supplierName, S.contactPerson, S.telephoneNum, S.cellphoneNum,
																										S.faxNum, COUNT(SCD.materialID) as numToOrder, SC.scID
																	...
																	while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
																		if(in_array($row['scID'], $_SESSION['selectedSC'])){
																			echo '<tr>';
																				echo '<td>'.$row['supplierName'].'</td>';
																				echo '<td>'.$row['contactPerson'].'</td>';
																				echo '<td>'.$row['telephoneNum'].'</td>';
																				echo '<td>'.$row['cellphoneNum'].'</td>';
																				echo '<td>'.$row['faxNum'].'</td>';
																				echo '<td>'.$row['numToOrder'].'</td>';
																				echo '<td><button type="submit" value="'.$row['scID'].'" name="list">GENERATE</button>';
																			echo '</tr>';
																		}
																	}
																?>
