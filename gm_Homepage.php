					...
					<!-- START OF WIDGET -->
					  ...
					  <div class="info-box">
						...
						<div class="info-box-content">
						  ...
						  <span class="info-box-text"><font size=5>Verify Purchase Order (PO) for: <b><font size=5>Phase 2 (Footing)</font></b></font></span>
						  <span class="info-box-number"><a href="#"><button  style="width: 100%" type="button" class="btn btn-success btn-fill" >VERIFY PO</button></a></span>
