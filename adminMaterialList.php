...
if (isset($_POST['submit'])){
  ...
  header("Location: adminEditMaterial.php"); /* Redirect browser */
	exit();
						...
						<form style="height: 250px" action="adminEditMaterial.php" method="get">
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
								...
								$query="select * from materials join ref_units on materials.unitID = ref_units.unitID";
								...
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
									...
									<td>{$row['unit']}</td>
									<td><button value={$row['materialID']} type='submit' name='submit'>EDIT</td>
