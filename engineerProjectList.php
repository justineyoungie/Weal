...
if (isset($_POST['submit'])){
  ...
  header("Location: adminAssignProjectMembers.php"); /* Redirect browser */
	exit();
			...
			<section class="content-header">
			  ...
			  <ol class="breadcrumb">
                ...
                <div class="row">
					...
					<br>
                        <div class="col-xs-12">
						<form style="height: 250px" action="engineerAssignProjectMembers.php" method="get">
						  ...
						  <div class="col-xs-6 form-group">
							...
							<?php
								...
								while($row=mysqli_fetch_array($result,MYSQLI_ASSOC)){
									...
									<td>{$row['status']}</td>
									<td><button value={$row['projectCode']} type='submit' name='submit'>ASSIGN MEMBERS</td>
