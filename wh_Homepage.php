					...
					<!-- START OF WIDGET -->
					  ...
					  <div class="info-box">
						...
						<div class="info-box-content">
						  ...
						  <span class="info-box-text"><font size=5>Receive Materials for: <b><font size=5>Phase 2 (Footing)</font></b></font></span>
						  <span class="info-box-number"><a href="#"><button  style="width: 100%" type="button" class="btn btn-success btn-fill" >RECEIVE MATERIALS</button></a></span>
                ...
                <!-- START OF WIDGET -->
					  ...
					  <div class="info-box">
						...
						<div class="info-box-content">
						  ...
						  <span class="info-box-text"><font size=5>Pull Out Materials for: <b><font size=5>Phase 2 (Footing)</font></b></font></span>
						  <span class="info-box-number"><a href="#"><button  style="width: 100%" type="button" class="btn btn-success btn-fill" >PULL OUT MATERIALS</button></a></span>
